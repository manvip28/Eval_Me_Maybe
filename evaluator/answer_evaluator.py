...
def evaluate_from_json_files(student_file, answer_key_file):
    ...
    for question_id, answer_key_info in answer_key_data.items():
        if question_id in student_data:
            ...
            student_img = student_info.get("diagram") or student_info.get("Image")
            ...
            student_answer = student_info.get("text", "") or student_info.get("Text", "")
            ...
            if gt_answer.strip():
                ...
                results[question_id] = {
                    ...
                    "has_student_image": bool(student_info.get("diagram") or student_info.get("Image")),
...
def main():
    ...
    if len(sys.argv) == 3:
        ...
        print("Usage: python -m evaluator.answer_evaluator [student_answers.json] [answer_key.json]")
